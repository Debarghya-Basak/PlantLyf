...
public class PlantDiseaseClassifier {
    ...
    public PlantDiseaseClassifier(Context context, int inputImageWidth, int inputImageHeight, String[] labels) throws IOException {
    ...
    private ByteBuffer loadModelFile(Context context) throws IOException {
        ...
        // Load the TFLite model from the assets folder
        InputStream inputStream = context.getAssets().open("plant_disease_classifier.tflite");
